      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex items-center min-h-[55vh] sm:min-h-[65vh] md:min-h-[70vh]">
          <div className="text-center w-full">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-6 text-white drop-shadow-2xl tracking-wide leading-tight" 
                style={{ fontFamily: "'Playfair Display', serif" }}>
              Trendy & Affordable Fashion
            </h1>
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl mb-6 sm:mb-8 max-w-4xl mx-auto text-white leading-relaxed drop-shadow-lg p-3 sm:p-4 rounded-lg font-light tracking-wide" 
