      ...
      <footer className="bg-black text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Empowering Nigerians with stylish and affordable clothing that enhances confidence and individuality.
              </p>
            ...
            <div>
              ...
              <div className="space-y-3 text-gray-300">
                <div>
                  <p className="font-semibold text-white mb-1">📍 Our Locations:</p>
                  <p className="text-sm">Abuja, FCT</p>
                  <p className="text-sm">Bauchi, Bauchi State</p>
                  <p className="text-sm">Maiduguri, Borno State</p>
                  <p className="text-sm">Kano, Kano State</p>
                </div>
                <div>
                  <p>📞 <a href="tel:+2348123755353" className="hover:text-yellow-400">+234 812 375 5353</a></p>
                </div>
                <div>
                  <p>✉️ <a href="mailto:info@vitavogue.com.ng" className="hover:text-yellow-400">info@vitavogue.com.ng</a></p>
                </div>
              </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} Vitavogue Limited. All rights reserved.</p>
            <p className="text-sm mt-2">Empowering Nigerian Fashion</p>
          </div>
        </div>
      </footer>
    </>
