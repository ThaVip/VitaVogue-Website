          ...
          <div className="text-center w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <button
                ...
                disabled={isLoading}
                className="bg-gradient-to-r from-blue-400 to-blue-500 text-white font-bold py-3 px-6 rounded-lg hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              >
                {isLoading ? 'Getting accounts...' : username ? 'Get Accounts' : 'Login for Accounts'}
              </button>
            </div>
